...
export const metadata: Metadata = { title: "Professional Experience", description: "Madhur Jain's product management experience across PRISM, SplashLearn, and Honasa." };
  ...
  return (
    <><a className="skip-link" href="#experience-content">Skip to experience</a><SiteHeader />
      <main id="experience-content" className="bg-background text-foreground">
        <section className="mx-auto max-w-[90rem] px-5 pb-12 pt-14 md:px-10 md:pb-20 md:pt-24 xl:px-16"><h1 className="max-w-4xl text-5xl font-medium leading-[1.02] text-balance md:text-7xl">Professional experience.</h1><p className="mt-6 max-w-2xl text-base leading-7 text-muted md:text-lg md:leading-8">How my scope grew from ecommerce operations to D2C growth, mobile subscriptions, US consumer products, and AI product systems.</p></section>
        ...
        <section className="border-y border-line bg-surface py-16 md:py-24"><div className="mx-auto max-w-[90rem] px-5 md:px-10 xl:px-16">
          <div className="flex flex-col gap-5 border-b border-line pb-8 md:flex-row md:items-end md:justify-between"><h2 className="text-4xl font-medium md:text-5xl">Outcome matrix.</h2><p className="max-w-lg text-sm leading-6 text-muted">Each result is shown with the product context and metric it represents.</p></div>
