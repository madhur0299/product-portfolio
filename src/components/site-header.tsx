  ...
  return (
    <header className="sticky top-0 z-40 border-b border-line bg-surface/95 backdrop-blur">
      <div className="mx-auto flex min-h-16 max-w-7xl items-center justify-between gap-4 px-5 sm:px-8 lg:px-10">
        ...
        <a href={profile.resumePath} className="on-dark inline-flex min-h-11 shrink-0 items-center gap-2 rounded-md bg-foreground px-3 text-sm font-semibold transition-colors hover:bg-accent sm:px-4">
